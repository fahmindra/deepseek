...
![Figure 1: Illustrations of Residual Connection Paradigms.](https://arxiv.org/html/2512.02556v1/x1.png)
...
1. [Introduction](#S1)
2. [Related Works](#S2)
    2.1 [Micro Design](#S2.SS1)
    2.2 [Macro Design](#S2.SS2)
3. [Preliminary](#S3)
    3.1 [Numerical Instability](#S3.SS1)
    3.2 [System Overhead](#S3.SS2)
4. [Method](#S4)
    4.1 [Manifold-Constrained Hyper-Connections](#S4.SS1)
    4.2 [Parameterization and Manifold Projection](#S4.SS2)
    4.3 [Efficient Infrastructure Design](#S4.SS3)
5. [Experiments](#S5)
    5.1 [Experimental Setup](#S5.SS1)
    5.2 [Main Results](#S5.SS2)
    5.3 [Scaling Experiments](#S5.SS3)
    5.4 [Stability Analysis](#S5.SS4)
6. [Conclusion and Outlook](#S6)
7. [Appendix](#A1)
...
$$\mathbf{x}_{l+1}=\mathbf{x}_{l}+\mathcal{F}(\mathbf{x}_{l},\mathcal{W}_{l}), \quad (1)$$
...
![Figure 2: Training Instability of Hyper-Connections (HC).](https://arxiv.org/html/2512.02556v1/x2.png)
...
![Figure 3: Propagation Instability of Hyper-Connections (HC).](https://arxiv.org/html/2512.02556v1/x3.png)
...
![Figure 4: Communication-Computation Overlapping for mHC.](https://arxiv.org/html/2512.02556v1/x4.png)
...
![Figure 5: Training Stability of Manifold-Constrained Hyper-Connections (mHC).](https://arxiv.org/html/2512.02556v1/x5.png)
...
![Figure 6: Scaling properties of mHC compared to the Baseline.](https://arxiv.org/html/2512.02556v1/x6.png)
...
![Figure 7: Propagation Stability of Manifold-Constrained Hyper-Connections (mHC).](https://arxiv.org/html/2512.02556v1/x7.png)
...
![Figure 8: Visualizations of Learnable Mappings.](https://arxiv.org/html/2512.02556v1/x8.png)
